...
public class OtherworldPortalBlock extends ModBlock {
    ...
    public void onEntityCollision(BlockState p_196262_1_, World p_196262_2_, BlockPos p_196262_3_, Entity p_196262_4_) {
        ...
        if(!p_196262_2_.isRemote) {
            ...
            DimensionType destination = p_196262_2_.dimension.getType() == ModDimensions.OTHERWORLD.getType() ? DimensionType.OVERWORLD : ModDimensions.OTHERWORLD.getType();
            if(!player.isInvulnerableDimensionChange() && ForgeHooks.onTravelToDimension(player, destination)) {
